...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var btn = document.querySelector('.header__sub-btn'),
      popup = document.querySelector('.popup'),
      popupClose = document.querySelector('.popup__close'),
      input = document.querySelectorAll('input'),
      header = document.querySelector('.header__nav'),
      windowWidth = document.documentElement.clientWidth;
  var width = calcScroll();
  btn.addEventListener('click', function () {
    popup.classList.add('animate__animated', 'wow', 'animate__fadeIn');
    popup.style.display = 'block';
    document.body.style.overflow = 'hidden';
    document.body.style.marginRight = "".concat(width, "px");
    header.style.width = "".concat(windowWidth, "px");
    header.style.right = "".concat(width, "px");
  });
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('mailer/smart.php', formData).then(function (item) {
        console.log(item);
